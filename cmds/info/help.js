...
module.exports = class HelpCommand extends Command {
  ...
  execute(msg){
    ...
    .addField('**Comandos NSFW**', " Ejecuta el comando de ayuda en un canal marcado como NSFW para ver los comandos NSFW (Es obvio, ¿no?)")
    .addField('**Servidor de Soporte: **', `[RLBot Support](https://discord.gg/dwQsP2ssQR)`)
      
      const indice2 = new Discord.MessageEmbed()
    .setTitle('🛡 | Ayuda')
    .setColor("WHITE")
    .setDescription('**RLbot BETA v3.0 by Carlix - Lista de comandos**')
    .addField('🔧**-Sobre el bot**', " Muestra algunos de los comandos sobre el bot.")
    ...
    .addField('📱**-Entretenimiento**', " Muestra algunos comandos para entretenerse y perder el tiempo. ")
    .addField('👀**-Ocultos**', " Muestra algunos comandos un poco escondidos")
    .addField('🔞**-NSFW**', "Muestra comandos para mayores de edad (**Sólo funcionan en canales NSFW**)")
      .addField('**Servidor de Soporte: **', `[RLBot Support](https://discord.gg/dwQsP2ssQR)`)
...
const help_nsfw = new Discord.MessageEmbed()
    .setTitle('🔞 | Ayuda')
    .setDescription('Comandos NSFW (**Sólo disponibles en canales marcados como NSFW**)')
      .setColor("RED")
      .addField("**rl!hentai**", "Ya sabes lo que significa...") 
      .addField("**rl!masturbation**", "También lo sabes...")
      .addField("**rl!orgy**", "Una fiesta demasiado loca.")
      .addField("**rl!lewdfoxgirl**", "Mujer zorro, todo lo que necesitas.")
    .setFooter(`Usa 🌎 para volver al índice`)
...
if(reaction.emoji.name === '👀') { 
    ...
    if(msg.channel.nsfw) {  
    msg.channel.send(indice2).then(m => {
        m.react('🌎')
        m.react('🔧')
        m.react('📷')
        m.react('🤝')
